...
class BasePair:
    ...
    def __init__(self, base1, base2, identifier=None):
        ...
        self.atom_identifiers = self.base1.atom_identifiers + self.base2.atom_identifiers
        ...
        self.orbital_identifiers = self.base1.orbital_identifiers + self.base2.orbital_identifiers
