...
def get_lm_config(num_sites_per_strand, strand1=0, strand2=1):
    ...
    wm_config_strand2 = get_wm_config(num_sites_per_strand, strand=strand2, reversed_direction=True)
    h_list = [
        ("h", str((strand1, site)), str((strand2, site))) for site in range(num_sites_per_strand)
    ]
