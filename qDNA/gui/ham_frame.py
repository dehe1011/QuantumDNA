...
class HamFrame(ctk.CTkFrame):
    def __init__(self, master, configs, **kwargs):
        ...
        self.ham_coulomb_param_entry.insert(0, str(self.ham_kwargs_default["coulomb_param"]))
        ...
        self.ham_exchange_param_entry.insert(0, str(self.ham_kwargs_default["exchange_param"]))
