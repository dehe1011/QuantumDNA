...
from DNA import check_diss_kwargs
from DNA.model import TB_Ham, TBHamType, add_groundstate, add_groundstate, global_to_local
...
class Lindblad_Diss:
    def __init__(self, tb_ham: TBHamType, **diss_kwargs):
        ...
        self.loc_deph_rate = self.diss_kwargs.get('loc_deph_rate') # rad/ps
        self.glob_deph_rate = self.diss_kwargs.get('glob_deph_rate') # rad/ps
        ...
        if self.uniform_relaxation: 
            ...
            self.relax_rates = self.diss_kwargs.get('relax_rates') # rad/ps
        self.loc_therm = self.diss_kwargs.get('loc_therm')
        self.glob_therm = self.diss_kwargs.get('glob_therm')
        self.deph_rate = self.diss_kwargs.get('deph_rate') # in rad/ps
        self.cutoff_freq = self.diss_kwargs.get('cutoff_freq') # in rad/ps
        self.reorg_energy = self.diss_kwargs.get('reorg_energy') # in rad/ps
