...
class qDNA_App(ctk.CTk):
    ...
    def get_plot_options_kwargs(self):
        ...
        self.fourier_kwargs = self.plot_options_frame.plot_options_tab.fourier_frame.get_fourier_kwargs() 
    ...
    def press_first_confirm(self):
        ...
        self.plot_options_frame.plot_options_tab.pop_frame.tb_site_combo.configure(values=self.tb_model.tb_basis)
        self.plot_options_frame.plot_options_tab.fourier_frame.tb_site_combo.configure(values=self.tb_model.tb_basis)
        self.plot_options_frame.plot_options_tab.fourier_frame.init_e_site_combo.configure(values=self.tb_model.tb_basis)
        self.plot_options_frame.plot_options_tab.fourier_frame.init_h_site_combo.configure(values=self.tb_model.tb_basis)
